  ...
  useEffect(() => {
    const fetchDevices = async () => {
      try {
        ...
        const res = await axios.get(`${API_BASE}/customer/all-devices`, {
...
useEffect(() => {
  ...
  const fetchAllMeasurements = async () => {
    try {
      ...
      // 2️⃣ Lấy children của từng parent
...
const styles = StyleSheet.create({
  container: { padding: 16, paddingTop: 48, backgroundColor: "#F3F4F6" },
